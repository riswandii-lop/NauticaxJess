...
const zoneID = "b3b0651fb8c440604cae78ac23b3fccb"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
const DONATE_LINK = "https://t.me/Donasivpn";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("<span class='text-yellow-500 font-semibold'>Selamat datang!<br>Terima kasih telah mengunjungi<br>Worker JessVpntunnel</span>");
...
document.addPageButton("qris", "https://i.imghippo.com/files/Rfn7163R.jpg", false); // No condition for disabling, just a link
